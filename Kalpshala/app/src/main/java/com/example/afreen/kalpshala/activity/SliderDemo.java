...
public class SliderDemo extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(String name : Hash_file_maps.keySet()){
            ...
            TextSliderView textSliderView = new TextSliderView(SliderDemo.this);
            textSliderView
                    .description(name)
